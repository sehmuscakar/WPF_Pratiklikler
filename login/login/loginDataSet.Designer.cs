...
namespace login.loginDataSetTableAdapters {
    ...
    public partial class loginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[login] WHERE (([loginid] = @Original_loginid) AND ((@IsNull_ku" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[login] ([kullaniciAdi], [sifre]) VALUES (@kullaniciAdi, @sifre" +
                ");\r\nSELECT loginid, kullaniciAdi, sifre FROM login WHERE (loginid = SCOPE_IDENTI" +
                "TY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[login] SET [kullaniciAdi] = @kullaniciAdi, [sifre] = @sifre WHERE (([loginid] = @Original_loginid) AND ((@IsNull_kullaniciAdi = 1 AND [kullaniciAdi] IS NULL) OR ([kullaniciAdi] = @Original_kullaniciAdi)) AND ((@IsNull_sifre = 1 AND [sifre] IS NULL) OR ([sifre] = @Original_sifre)));
SELECT loginid, kullaniciAdi, sifre FROM login WHERE (loginid = @loginid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT loginid, kullaniciAdi, sifre FROM dbo.login";
        ...
        public virtual int Delete(int Original_loginid, string Original_kullaniciAdi, global::System.Nullable<int> Original_sifre) {
        ...
        public virtual int Update(string kullaniciAdi, global::System.Nullable<int> sifre, int Original_loginid, string Original_kullaniciAdi, global::System.Nullable<int> Original_sifre, int loginid) {
            if ((kullaniciAdi == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string kullaniciAdi, global::System.Nullable<int> sifre, int Original_loginid, string Original_kullaniciAdi, global::System.Nullable<int> Original_sifre) {
            return this.Update(kullaniciAdi, sifre, Original_loginid, Original_kullaniciAdi, Original_sifre, Original_loginid);
        }
    }
